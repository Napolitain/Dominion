...
public class GameProxy {
	...
	public GameProxy(Game g) {
		...
		try {
			...
			this.currentPlayerIndex_f = Game.class
	...
	/**
	 * Fixe la liste d'instructions du jeu. N'a d'effet que si le jeu est une
	 * instance de IOGame
	 * 
	 * @param args
	 *            liste de chaînes de caractères. Chaque élément est une
	 *            instruction (sans '\n' à la fin)
	 */
